...
CREATE TABLE `accounts` (
  ...
  `img` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless',
...
CREATE TABLE `apps` (
  ...
  `customerPanelIcon` varchar(200) NOT NULL DEFAULT 'https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless',
...
CREATE TABLE `webhooks` (
  ...
  `useragent` varchar(49) NOT NULL DEFAULT 'Astreon Auth',
  `app` varchar(64) NOT NULL,
  `authed` int NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
