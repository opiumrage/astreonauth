...
<head>
    ...
    <meta name="title" content="Astreon Auth - Open Source Auth">
    ...
    <meta content="Astreon Auth" name="author" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="Astreon Auth, Cloud Authentication, Key Authentication,Authentication, API authentication,Security, Encryption authentication, Authenticated encryption, Cybersecurity, Developer, SaaS, Software Licensing, Licensing" />
    ...
    <meta property="og:image" content="https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless" />
    <meta property="og:site_name" content="Astreon Auth | Secure your software from piracy." />
    <link rel="shortcut icon" type="image/jpg" href="https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless">

    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="Astreon Auth - Open Source Auth">
    ...
    <meta itemprop="image" content="https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless">

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="product">
    <meta name="twitter:site" content="@astreonauth">
    <meta name="twitter:title" content="Astreon Auth - Open Source Auth">
    ...
    <meta name="twitter:creator" content="@astreonauth">
    <meta name="twitter:image" content="https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless">

    <!-- Open Graph data -->
    <meta property="og:title" content="Astreon Auth - Open Source Auth" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="./" />

    <title>Astreon Auth - Register</title>
...
<body>
        ...
        <nav class="border-gray-200 px-4 lg:px-6 py-2.5 mb-14">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="../" class="flex items-center">
                    <img src="https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless" class="mr-3 h-12 mt-2" alt="Astreon Auth Logo" />
                </a>
            ...
            <div class="w-full md:w-1/2 md:p-8">
                ...
                <h2
                    class="mb-7 md:mb-12 text-3xl md:text-6xl font-bold font-heading tracking-px-n leading-tight text-center">
                        Welcome to <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-sky-400">Astreon Auth</span>!
                    </h2>
    ...
    <footer class="mt-32">
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10 pt-32 md:pt-0">
            <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
                <div class="col-span-2">
                    ...
                    <p class="my-4 font-light text-gray-400">
                        Astreon Auth is a game-changing, affordable and easy to use licensing solution for your software.
                    </p>
            ...
            <span class="block mb-6 text-sm text-gray-400 lg:mb-0 text-center">© 2020 - 2023 <a href="../" class="hover:underline">Astreon Auth LLC</a>. All Rights Reserved.
            </span>
        </div>
    </footer>
    ...
    if (isset($_POST['register'])) {
        ...
        $htmlContent = "<html>
                                        <body>
                                                ...
                                                <p>Astreon Auth code can be seen here <a href=\"https://github.com/KeyAuth/\">https://github.com/KeyAuth/</a></p>
                                                <p>Astreon Auth API documentation can be seen here <a href=\"https://keyauth.readme.io/\">https://keyauth.readme.io/</a></p>
                                                <p>Please leave a review on TrustPilot if you enjoy Astreon Auth <a href=\"https://trustpilot.com/review/keyauth.com\">https://trustpilot.com/review/keyauth.com</a></p>
                                                <p style=\"margin-top: 20px;\">Thanks,<br><b>Astreon Auth.</b></p>
                                        </body>
                                        </html>";
        misc\email\send($username, $email, $htmlContent, "Welcome to Astreon Auth");
        $_SESSION['logindate'] = time();
        $_SESSION['username'] = $username;
        $_SESSION['ownerid'] = $ownerid;
        $_SESSION['role'] = 'tester';
        $_SESSION['img'] = 'https://media.discordapp.net/attachments/1447024486254776381/1447630572800442418/987a4d9ad29543af93c8e3924674656c.png?ex=6938fb48&is=6937a9c8&hm=0b4be8faa0c91f83c16f01a05d6574ce9bd9f1b2aab364f05550c8db195a360c&=&format=webp&quality=lossless';
        header("location: ../app/");
    }
    ?>
</body>
